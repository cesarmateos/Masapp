...
class Predespacho(btHandler: BTHandler): Fragment() {
    ...
    override fun onCreateView(
        ...
        val botCargaE11: Button = vistaRetorno.findViewById(R.id.botImprimeE11Continuo)
        ...
        val botImprimeE11: Button = vistaRetorno.findViewById(R.id.botImprimeE11Etiqueta)
